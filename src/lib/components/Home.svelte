...
<div class=" h-screen flex-col flex items-center">
  <h1 class="font-extrabold text-3xl py-10">Who are we selling to?</h1>

  <div class=" flex flex-col md:flex-row justify-between w-full p-10">
    <div class=" flex flex-col items-start h-full w-[40vw]">
      <h1 class="font-extrabold text-black text-5xl my-5">
